...
exports.register = async (req, res) => {
  try {
    const { name, email, password, adminSecret } = parseRequestBody(req.body);
    ...
    await PendingUser.create({ name, email, password: hashedPassword, role, otp });
    ...
    console.warn("check with entered credentials")
    console.error(error);
...
exports.verifyOtp = async (req, res) => {
  try {
    const { email, otp } = parseRequestBody(req.body);
